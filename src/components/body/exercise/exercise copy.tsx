...
export default function Exercise({ defaultExerciseSet, setDefaultExerciseSet, name, description, index }: TaskProps) {
    return <>
        <div className="flex p-6 mb-2 bg-white rounded-xl shadow-lg text-left break-all">
            <div>
